...
$query = $db->prepare("select count(*) from urls");
$query->execute();
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="/panel/links"><i class="fa fa-dashboard fa-fw"></i> Linkler</a>
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <p>Sistem her geçen gün geliştirilmektedir.Eklenmesini istediğiniz özellikleri admin@mertcangokgoz.com e-posta adresine mail atarak talepde bulunabilirsiniz.</p>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <p>Yeni Sürümümüz yayına alınmıştır.Tasarımsal hatalar en kısa sürede giderilecektir.</p>
                    </div>
                    <div class="panel-footer">
                        0x2e88ce4 | Admin
                    </div>
