...
if(isset($_POST['btn-submit']))
{
	...
	if($stmt->rowCount() == 1)
	{
		...
		$message= "
				   ...
				   <br /><br />
				   <a href='https://simple-url-shorttest-mertcangokgoz.c9users.io/resetpassword.php?id=$id&code=$code'>Şifrenizi sıfırlamak için tıklayın</a>
				   <br /><br />
				   Teşekkürler :)
				   ";
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post">
        <h2 class="form-signin-heading">Şifreni mi Unuttun</h2><hr />
     	...
     	<hr />
        <button class="btn btn-primary btn-lg btn-block login-button" type="submit" name="btn-submit">Yeni Şifre İsteği</button>
      </form>
            </div>
        </div>
    </div>
